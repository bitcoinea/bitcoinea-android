...
public class ServerTest {
    ...
    public void testGetMarketInfo() throws ShapeShiftException, IOException, InterruptedException, JSONException {
        ...
        Assert.assertEquals(BTC.value("4"), marketInfoReply.limit);
        Assert.assertEquals(BTC.value("0.00000104"), marketInfoReply.minimum);
    ...
    public void testGetRate() throws ShapeShiftException, IOException, InterruptedException, JSONException {
        ...
        Assert.assertEquals(LTC, rateReply.rate.convert(BTC.oneCoin()).type);
        Assert.assertEquals(BTC, rateReply.rate.convert(LTC.oneCoin()).type);
    ...
    public void testGetLimit() throws ShapeShiftException, IOException, InterruptedException, JSONException {
        ...
        Assert.assertEquals(BTC, limitReply.limit.type);
        Assert.assertEquals("5", limitReply.limit.toPlainString());
    ...
    public void testGetTxStatus() throws ShapeShiftException, IOException, InterruptedException, JSONException, AddressFormatException {
        ...
        assertEquals(address, txStatusReply.address);
        Assert.assertEquals("0.00297537", txStatusReply.incomingValue.toPlainString());
        Assert.assertEquals(BTC, txStatusReply.incomingValue.type);
        ...
        Assert.assertEquals("0.42", txStatusReply.outgoingValue.toPlainString());
        Assert.assertEquals(LTC, txStatusReply.outgoingValue.type);
    ...
    public void testFixedAmountTransaction() throws ShapeShiftException, IOException,
        ...
        Assert.assertEquals("0.00052379", amountTxReply.depositAmount.toPlainString());
        Assert.assertEquals(BTC, amountTxReply.depositAmount.type);
        ...
        Assert.assertEquals(amount.toPlainString(), amountTxReply.withdrawalAmount.toPlainString());
        Assert.assertEquals(DOGE, amountTxReply.withdrawalAmount.type);

        assertEquals(1427149038191L, amountTxReply.expiration.getTime());
        Assert.assertEquals(BTC.value(".00052379"), amountTxReply.rate.convert(Value.parse(DOGE, "1000")));
