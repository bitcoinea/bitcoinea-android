package org.bitcoinea.core.exchange.shapeshift;

import org.bitcoinea.core.coins.BitcoinMain;
import org.bitcoinea.core.coins.CoinType;
import org.bitcoinea.core.coins.DogecoinMain;
...
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftAmountTx;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftCoin;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftCoins;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftEmail;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftException;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftLimit;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftMarketInfo;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftNormalTx;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftRate;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftTime;
import org.bitcoinea.core.exchange.shapeshift.data.ShapeShiftTxStatus;
...
public class MessagesTest {
    ...
    public void testMarketInfo() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(BTC.value("4"), marketInfo.limit);
        Assert.assertEquals(BTC.value("0.00000104"), marketInfo.minimum);
    }
    ...
    public void testMarketInfo2() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(PPC.value("2162.119259"), info.limit);
        Assert.assertEquals(PPC.value("0.173914"), info.minimum);
        ...
        Assert.assertEquals(BTC.value("1.1185671"), info.limit);
        Assert.assertEquals(BTC.value("0.0000198"), info.minimum);
        ...
        Assert.assertEquals(BTC.value("3.70968678"), info.limit);
        Assert.assertEquals(BTC.value("0.00008692"), info.minimum);
        ...
        Assert.assertEquals(NBT.value("1021.5033"), info.limit);
        Assert.assertEquals(NBT.value("0.0455"), info.minimum);
    }
    ...
    public void testRateWithoutMinerFee() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(LTC.value("100"), rate.rate.convert(BTC.value("1")));
        Assert.assertEquals(LTC.value("1"), rate.rate.convert(BTC.value("0.01")));
        Assert.assertEquals(BTC.value("0.01"), rate.rate.convert(LTC.value("1")));
        Assert.assertEquals(BTC.value("1"), rate.rate.convert(LTC.value("100")));
    }
    ...
    public void testRateWithoutMinerFee2() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(NBT, rate.rate.convert(ONE_BTC).type);
        Assert.assertEquals(BTC, rate.rate.convert(NBT.oneCoin()).type);
    }
    ...
    public void testRateWithMinerFee() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(NBT.value("99.99"), rate.rate.convert(BTC.value("1")));
        Assert.assertEquals(BTC.value("1"), rate.rate.convert(NBT.value("99.99")));
    }
    ...
    public void testLimit() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(LTC.value("200"), limit.limit);
        Assert.assertEquals(LTC.value("0.00014772"), limit.minimum);
    }
    ...
    public void testLimit2() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(NBT.value("1015.1535"), limit.limit);
        Assert.assertEquals(NBT.value("0.0532"), limit.minimum);
    }
...
//        assertEquals("1NDQPAGamGePkSZXW2CYBzXJEefB7N4bTN", txStatus.address.toString());
    ...
    public void testTxStatus2() throws JSONException, ShapeShiftException {
        ...
        assertNull(txStatus.withdraw);
        Assert.assertEquals(BTC.value("0.00297537"), txStatus.incomingValue);
        assertNull(txStatus.outgoingValue);
        assertNull(txStatus.transactionId);
    }
    ...
    public void testTxStatus3() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(BTC.value("0.00297537"), txStatus.incomingValue);
        Assert.assertEquals(LTC.value("0.42"), txStatus.outgoingValue);
    ...
    public void testTxStatus3Alt() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(BTC.value("0.01"), txStatus.incomingValue);
        Assert.assertEquals(NBT.value("2.33"), txStatus.outgoingValue);
        assertEquals("66fa0b4c11227f9f05efa13d23e58c65b50acbd6395a126b5cd751064e6e79df",
                txStatus.transactionId);
    }
    ...
    public void testAmountTxWithoutMinerFee() throws JSONException, ShapeShiftException {
        ...
        Assert.assertEquals(BTC.value("0.00052327"), amountTx.depositAmount);
        ...
        Assert.assertEquals(DOGE.value("1000"), amountTx.withdrawalAmount);
        assertEquals(1427149038191L, amountTx.expiration.getTime());
        Assert.assertEquals(BTC.value("0.00052327"), amountTx.rate.convert(Value.parse(DOGE, "1000")));
    }
    ...
    public void testAmountTxWithMinerFee() throws JSONException, ShapeShiftException {
        ...
        assertEquals("14gQ3xywKEUA6CfH61F8t2c6oB5nLnUjL5", amountTx.deposit.toString());
        assertEquals(BTC, amountTx.deposit.getParameters());
        Assert.assertEquals(BTC.value("0.00052379"), amountTx.depositAmount);
        assertEquals("DMHLQYG4j96V8cZX9WSuXxLs5RnZn6ibrV", amountTx.withdrawal.toString());
        assertEquals(DOGE, amountTx.withdrawal.getParameters());
        Assert.assertEquals(DOGE.value("1000"), amountTx.withdrawalAmount);
        assertEquals(1427149038191L, amountTx.expiration.getTime());
        Assert.assertEquals(BTC.value("0.00052379"), amountTx.rate.convert(Value.parse(DOGE, "1000")));
    }
