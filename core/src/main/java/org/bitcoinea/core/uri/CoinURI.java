...
package org.bitcoinea.core.uri;
...
public class CoinURI {
    ...
    public CoinURI(@Nullable CoinType uriType, String input) throws CoinURIParseException {
        ...
        if (!addressToken.isEmpty()) {
            ...
            if (type == null){
                ...
                Preconditions.checkState(type.equals(address.getParameters()));
            }
        }
    ...
    private void parseParameters(String[] nameValuePairTokens, List<CoinType> possibleTypes) throws CoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (FIELD_AMOUNT.equals(nameToken)) {
                ...
                try {
                    Value amount = Preconditions.checkNotNull(type).value(valueToken);
                    if (amount.signum() < 0) {
     ...
     * @return The {@link CoinType} of this URI
     */
