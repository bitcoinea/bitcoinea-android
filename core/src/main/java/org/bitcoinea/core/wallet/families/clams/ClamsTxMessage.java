package org.bitcoinea.core.wallet.families.clams;
...
public class ClamsTxMessage implements TxMessage {
    ...
    public void setMessage(String message) {
        Preconditions.checkArgument(serialize(message).length <= MAX_MESSAGE_BYTES, "Message is too big");
    ...
    public static ClamsTxMessage parse(Transaction tx) {
        ...
        Preconditions.checkArgument(bytes.length <= MAX_MESSAGE_BYTES, "Maximum data size exceeded");
