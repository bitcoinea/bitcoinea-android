...
import org.bitcoinea.core.network.ConnectivityHelper;
import org.bitcoinea.core.network.ServerClients;
...
//        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, lockName);
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId) {
        ...
        } else if (ACTION_CLEAR_CONNECTIONS.equals(action)) {
            disconnectClients();
        } else if (ACTION_RESET_ACCOUNT.equals(action)) {
