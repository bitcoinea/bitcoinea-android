...
import org.bitcoinea.core.coins.BitcoinEAMain;
import org.bitcoinea.core.coins.BitcoinMain;
import org.bitcoinea.core.coins.CbitMain;
import org.bitcoinea.core.coins.BitcoinTest;
import org.bitcoinea.core.coins.BlackcoinMain;
import org.bitcoinea.core.coins.CanadaeCoinMain;
import org.bitcoinea.core.coins.CannacoinMain;
import org.bitcoinea.core.coins.ClamsMain;
import org.bitcoinea.core.coins.CoinID;
import org.bitcoinea.core.coins.CoinType;
import org.bitcoinea.core.coins.DashMain;
import org.bitcoinea.core.coins.DigibyteMain;
import org.bitcoinea.core.coins.DigitalcoinMain;
import org.bitcoinea.core.coins.DogecoinMain;
import org.bitcoinea.core.coins.DogecoinTest;
import org.bitcoinea.core.coins.DogecoindarkMain;
import org.bitcoinea.core.coins.FeathercoinMain;
import org.bitcoinea.core.coins.GcrMain;
import org.bitcoinea.core.coins.JumbucksMain;
import org.bitcoinea.core.coins.LitecoinMain;
import org.bitcoinea.core.coins.LitecoinTest;
import org.bitcoinea.core.coins.MonacoinMain;
import org.bitcoinea.core.coins.NamecoinMain;
import org.bitcoinea.core.coins.NeoscoinMain;
import org.bitcoinea.core.coins.NovacoinMain;
import org.bitcoinea.core.coins.NuBitsMain;
import org.bitcoinea.core.coins.NuSharesMain;
import org.bitcoinea.core.coins.ParkbyteMain;
import org.bitcoinea.core.coins.PeercoinMain;
import org.bitcoinea.core.coins.ReddcoinMain;
import org.bitcoinea.core.coins.RubycoinMain;
import org.bitcoinea.core.coins.ShadowCashMain;
import org.bitcoinea.core.coins.UroMain;
import org.bitcoinea.core.coins.VertcoinMain;
import org.bitcoinea.core.coins.VpncoinMain;
import org.bitcoinea.core.network.CoinAddress;
import org.bitcoinea.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(CbitMain.get(),         new ServerAddress("159.203.121.70", 50001),
                                                    new ServerAddress("159.203.121.70", 50001)),
            ...
            new CoinAddress(BitcoinEAMain.get(),      new ServerAddress("159.89.168.17", 5035)),
    ...
    static {
		...
		COINS_ICONS.put(CoinID.CBIT_MAIN.getCoinType(), R.drawable.cbit);
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.BITCOINEA_MAIN.getCoinType(), R.drawable.bitcoinea);

        COINS_BLOCK_EXPLORERS = new HashMap<CoinType, String>();
        COINS_BLOCK_EXPLORERS.put(CoinID.BITCOIN_MAIN.getCoinType(), "https://blockchain.info/tx/%s");
		COINS_BLOCK_EXPLORERS.put(CoinID.CBIT_MAIN.getCoinType(), "http://cryptobe.com/tx/%s");
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.BITCOINEA_MAIN.getCoinType(), "http://159.89.168.17/tx/%s");
    }

    public static final CoinType DEFAULT_COIN = BitcoinEAMain.get();
