...
import org.bitcoinea.core.coins.FiatType;
...
import org.bitcoinea.core.messages.MessageFactory;
import org.bitcoinea.core.messages.TxMessage;
import org.bitcoinea.core.uri.CoinURI;
import org.bitcoinea.core.uri.CoinURIParseException;
...
import wallet.AddressBookProvider;
import wallet.Configuration;
import wallet.Constants;
import wallet.ExchangeRatesProvider;
import org.bea.wallet.R;
import wallet.WalletApplication;
import wallet.tasks.MarketInfoPollTask;
import wallet.ui.widget.AddressView;
import wallet.ui.widget.AmountEditView;
import wallet.util.ThrottlingWalletChangeListener;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            if (args.containsKey(Constants.ARG_ACCOUNT_ID)) {
                ...
                pocket = Preconditions.checkNotNull(application.getAccount(accountId));
            }
            ...
            Preconditions.checkNotNull(pocket, "No account selected");
        } else {
